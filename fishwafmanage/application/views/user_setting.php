    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li class="li1 active"><a href="<?=site_url('manage/user_setting');?>">User Setting</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div>
            <h2 class="sub-header">User Setting</h2>
            <h3 class="sub-header">Change Password</h3>
            <form class="form-horizontal" role="form" method="POST">
              <div class="form-group">
                <label for="inputRealIP" class="col-sm-2 control-label">Old Password</label>
                <div class="col-sm-10">
                  <input type="password" name="old_password" class="form-control" placeholder="Please input the old password">
                </div>
              </div>
              <div class="form-group">
                <label for="inputRealPort" class="col-sm-2 control-label">New Password</label>
                <div class="col-sm-10">
                  <input type="password" name="new_password" class="form-control" placeholder="Please input the new password">
                </div>
              </div>
              <div class="form-group">
                <label for="inputRealPort" class="col-sm-2 control-label">Confirm Password</label>
                <div class="col-sm-10">
                  <input type="password" name="confirm_password" class="form-control" placeholder="Please confirm the new password">
                </div>
              </div>
          ...
          <div class="footer">
            <p class="text-muted fleft"><a href="<?=site_url('manage/delay_rule');?>">&lt;-previous</a></p>
          </div>
        </div>
      </div>
    </div>
